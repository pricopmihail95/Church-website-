...
export default function SpiritualQuotes({ lang }: SpiritualQuotesProps) {
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-byz-blue-50/20 to-byz-blue-100/30 dark:from-byz-blue-900 dark:to-byz-blue-950 text-stone-900 dark:text-byz-blue-100 border-b border-byz-blue-100/50 dark:border-byz-blue-900 transition-colors duration-300">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10">
          ...
          <p className="font-serif text-stone-600 dark:text-byz-blue-300 text-xs sm:text-sm italic mt-1.5">
            {t.wisdomSubtitle}
          </p>
        </div>

        {/* Sliding card */}
        <div className="relative bg-white dark:bg-byz-blue-900/40 border border-byz-blue-100/80 dark:border-byz-blue-900/60 rounded-3xl p-8 sm:p-12 shadow-xl overflow-hidden">
          ...
          <div className="relative min-h-[170px] flex flex-col justify-between">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <blockquote className="font-serif text-lg sm:text-xl lg:text-2xl text-stone-800 dark:text-byz-blue-100 italic leading-relaxed px-2 sm:px-6 mb-6">
                ...
                <div className="flex items-center justify-center space-x-2">
                  ...
                  <span className="font-mono text-[9px] text-byz-blue-600 dark:text-byz-blue-300 bg-byz-blue-50/80 dark:bg-byz-blue-950 border border-byz-blue-100/40 dark:border-byz-blue-900 px-2 py-0.5 rounded">
                    {activeQuote.period}
                  </span>
                  <span className="w-1.5 h-[1px] bg-gold-500/50" />
                </div>
            ...
            <div className="flex items-center justify-between mt-10 pt-6 border-t border-byz-blue-100/50 dark:border-byz-blue-900/60">
              <button
                onClick={handlePrev}
                className="p-2 sm:p-3 rounded-full hover:bg-byz-blue-50 dark:hover:bg-byz-blue-900/60 text-byz-blue-800 dark:text-byz-blue-200 hover:text-byz-blue-900 dark:hover:text-white transition-colors border border-byz-blue-100/40 dark:border-byz-blue-800 cursor-pointer"
              ...
              <div className="flex items-center space-x-3">
                <button
                  onClick={handleCopy}
                  className="flex items-center space-x-1.5 px-3.5 py-2 rounded-xl text-[10px] uppercase font-mono tracking-widest font-semibold bg-byz-blue-50 hover:bg-byz-blue-100 dark:bg-byz-blue-950 dark:hover:bg-byz-blue-900 hover:text-byz-blue-900 dark:hover:text-white text-byz-blue-800 dark:text-byz-blue-300 transition-colors border border-byz-blue-100/45 dark:border-byz-blue-900/50 cursor-pointer"
                >
