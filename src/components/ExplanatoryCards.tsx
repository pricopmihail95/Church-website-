...
export default function ExplanatoryCards({ lang }: ExplanatoryCardsProps) {
  return (
    <section id="explanation" className="py-12 bg-byz-blue-50/20 text-stone-900 dark:bg-byz-blue-950 dark:text-byz-blue-100 border-b border-byz-blue-100 dark:border-byz-blue-900 transition-colors duration-300">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Centered Single Card */}
        <div className="bg-white dark:bg-byz-blue-900/60 border border-byz-blue-100 dark:border-byz-blue-800/40 p-6 sm:p-8 rounded-3xl shadow-sm flex flex-col justify-between hover:border-gold-500/20 transition-all duration-300">
          <div>
            ...
            <p className="font-serif text-xs sm:text-sm text-stone-600 dark:text-byz-blue-100 italic leading-relaxed">
              {lang === 'RO' ? (
          ...
          <div className="mt-6 pt-4 border-t border-stone-100 dark:border-byz-blue-800 text-[10px] font-mono uppercase tracking-wider text-stone-400">
