...
export default function HistorySection({ lang }: HistorySectionProps) {
  ...
  return (
    <section id="history" className="py-24 bg-white text-stone-900 dark:bg-byz-blue-950 dark:text-byz-blue-100 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="font-serif text-stone-650 dark:text-byz-blue-200 text-sm sm:text-base italic max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="relative group bg-byz-blue-50/20 dark:bg-byz-blue-900/40 border border-byz-blue-100/60 dark:border-byz-blue-900/50 p-8 sm:p-10 rounded-3xl flex flex-col justify-between hover:border-gold-500/30 transition-all duration-350 shadow-sm">
            ...
            <div>
              ...
              <p className="font-serif text-sm text-stone-700 dark:text-byz-blue-200 italic mb-8 leading-relaxed">
                {t.historyPatriarchateDesc}
              </p>
            </div>

            {/* Fapte scriptural quotation */}
            <div className="bg-white dark:bg-byz-blue-950/80 p-4 rounded-2xl border border-byz-blue-100/50 dark:border-byz-blue-900/60 text-xs font-serif italic text-gold-700 dark:text-gold-300 leading-relaxed">
              {lang === 'RO'
        ...
        <div className="mt-12 max-w-6xl mx-auto">
          <div className="relative overflow-hidden bg-byz-blue-50/20 dark:bg-byz-blue-900/40 border border-byz-blue-100/60 dark:border-byz-blue-900/50 p-8 sm:p-10 rounded-3xl hover:border-gold-500/30 transition-all duration-350 shadow-sm">
            ...
            <p className="mt-6 font-serif text-sm text-stone-700 dark:text-byz-blue-200 italic leading-relaxed md:max-w-4xl">
