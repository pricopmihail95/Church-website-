...
export const TRANSLATIONS: Record<'RO' | 'EN', TranslationSchema> = {
  RO: {
    ...
    contactSubtitle: 'Dacă doriți să vorbiți cu Părintele Mihai, completați formularul de mai jos.',
  ...
  EN: {
    ...
    contactSubtitle: 'Should you wish to speak to Father Mihai, fill the form below.',
