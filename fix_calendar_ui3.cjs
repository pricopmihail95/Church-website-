...
const t1 = content.substring(content.indexOf('{parishData.patronSaint?.imageUrl && ('), content.indexOf('</div>\n                  )}', content.indexOf('{parishData.patronSaint?.imageUrl && (')) + '</div>\n                  )}'.length);

const r1 = `                    <div className="flex-shrink-0">
...
if (t1.includes('{parishData.patronSaint?.imageUrl && (')) {
    content = content.replace(t1, r1);
}

const t2 = content.substring(content.indexOf('{parishData.patronSaint?.moreInfoUrl && ('), content.indexOf('</a>\n                    )}', content.indexOf('{parishData.patronSaint?.moreInfoUrl && (')) + '</a>\n                    )}'.length);

const r2 = `                    <div className="mt-2">
                      <a 
...
if (t2.includes('{parishData.patronSaint?.moreInfoUrl && (')) {
